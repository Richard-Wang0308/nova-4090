...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument('--start_epoch', type=int, default=22406, help='Starting epoch number to collect from')
    parser.add_argument('--end_epoch', type=int, default=22425, help='Ending epoch number to collect to')
