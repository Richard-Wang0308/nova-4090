...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument('--start_epoch', type=int, default=22477, help='Starting epoch number to collect from')
    parser.add_argument('--end_epoch', type=int, default=22484, help='Ending epoch number to collect to')
    parser.add_argument('--metric', type=str, default='boltz', help='Metric type')
    parser.add_argument('--output', type=str, default='data/b.csv', help='Output CSV file')
