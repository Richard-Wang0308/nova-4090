...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument('--start_epoch', type=int, default=22225, help='Starting epoch number to collect from')
    parser.add_argument('--end_epoch', type=int, default=22236, help='Ending epoch number to collect to')
